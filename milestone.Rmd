...
corpus <- Corpus("D:/coursera-capstone-master/en_US", readerControl=list(reader=readPlain))
...
## Links
1. The source code for this report can be found here: https://github.com/NohaMohamed244/ProgrammingAssignment2
